...
const DEMO_DATA = {
  ...
  staff: [
    ...
    },
    {
      ...
      speedFactor: 1.0,
      color: '#1ABC9C',
      calendarId: 'watanabe@example.com',
    },
    {
      id: 'S007',
      name: '中村 さくら',
      ...
      speedFactor: 0.6,
      color: '#F39C12',
      calendarId: 'nakamura@example.com',
    },
    {
      id: 'S008',
      name: '小林 勇太',
      ...
      speedFactor: 1.0,
      color: '#27AE60',
      calendarId: 'kobayashi@example.com',
    },
    {
      id: 'S009',
      name: '加藤 美穂',
    ...
    },
    {
      ...
      speedFactor: 1.0,
      color: '#D35400',
      calendarId: 'matsumoto@example.com',
    },
    {
      id: 'S011',
      name: '井上 幸子',
  ...
  patients: [
    {
      id: 'P001', name: '高橋 義雄', category: '医療',
    ...
    {
      id: 'P002', name: '渡辺 幸子', category: '介護',
    ...
    {
      id: 'P003', name: '伊藤 正治', category: '医療',
    ...
    {
      id: 'P004', name: '小林 美代子', category: '介護',
    ...
    {
      id: 'P005', name: '加藤 一男', category: '医療',
    ...
    {
      id: 'P006', name: '吉田 春江', category: '介護',
    ...
    {
      id: 'P007', name: '山口 利夫', category: '医療',
    ...
    {
      id: 'P008', name: '中村 敏子', category: '医療',
    ...
    {
      id: 'P010', name: '井上 節子', category: '医療',
